...
# Parameters.
BASE_PATH = "finetune"
OUTPUT_PATH = "generated_Flux"
CSV_FILENAME = "log_Flux.csv"
DEVICE = "cuda"
MODEL_PATH = "/scratch/vvnmax002/checkpoints/Flux_full.safetensors"
...
# First the base Flux model.
pipe = FluxFillPipeline.from_pretrained(
    "black-forest-labs/FLUX.1-Fill-dev",
    torch_dtype=torch.bfloat16
).to(DEVICE)
# Then the LoRA weights.
pipe.load_lora_weights(MODEL_PATH, adapter_name="default")
